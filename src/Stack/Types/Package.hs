...
data Package =
  Package {packageName :: !PackageName
          ...
          -- This is (maybe) PackageIdentifier pkgVersion in cabal.
          ...
          --
          -- see packageDescTools for more details.
          ...
          --    - <https://hackage.haskell.org/package/Cabal-3.2.1.0/docs/Distribution-PackageDescription.html#v:targetBuildDepends targetBuildDepends function>
          --
          -- Should be pointless in component based builds given that all deps are within a component.
          ...
          -- Derived from cabal ?
          -- Should be replaced by the original values ?
          ...
          -- Likely derived from cabal 'SetupBuildInfo'.
